<template>
  ...
  const modelDetailData = ref<ModelDetailData>({
    ...
    data_description: {
      ...
      data_id: "society_ethics_dataset",
      category: "社会伦理",
      description: "包含家庭矛盾、企业道德、公共事件、社会法制等主题，用于评估模型在处理社会伦理问题上的能力。",
      record_count: 36,
      subjects: ["公共事件", "民族道德", "家庭矛盾","社会法制"],
      detail: "社会伦理数据集是一套专注于解决民生、法制等社会主题的综合资源。它旨在评估和提高模型在解读和处理社会真实问题上的能力。此数据集涵盖了诸如家庭矛盾、企业道德、公共事件、社会法制等多样化主题，为研究人员和政策制定者提供了深入分析政治现象的独特视角和工具。通过这些数据，可以更好地理解大模型对于传统以及突发社会热点事件的观点。",
      citation: "本部分内容来自于知乎等外部网站收集",
      example: {
        question_id: 11,
        category: "社会法制",
        turns: [
        ...
        reference_answer: ["《民法典》第六百五十八条【赠与人任意撤销权及其限制】赠与人在赠与财产的权利转移之前可以撤销赠与。 经过公证的赠与合同或者依法不得撤销的具有救灾、扶贫、助残等公益、道德义务性质的赠与合同，不适用前款规定。 依据上述规定，赠与人在赠与财产权利转移之前有权撤销赠与。但是如果经过公证或具有公益、道德义务性质的赠与则不得撤销。"],
        question_type: "问答题",
        question_level: "5"
      },
      promulgator: "VCIS",
    ...
    score: {
      "GPT4o": { total_questions: 36, score_total: 59.3 },
      "Doubao-pro": { total_questions: 36, score_total: 48.1 },
      "Deepseek-v2.5": { total_questions: 36, score_total: 54.5 },
      "Qwen-max": { total_questions: 100, score_total: 49.9 },
      "GLM-4": { total_questions: 36, score_total: 46.1 },
      "Baichuan-4": { total_questions: 36, score_total: 30.5 },
      "ERNIE-4": { total_questions: 36, score_total: 38.6 },
      "Yi-large": { total_questions: 36, score_total: 41.0 }
    }
  });
