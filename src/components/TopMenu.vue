...
<template>
    <el-menu class="el-menu-demo" mode="horizontal" router :default-active="activeMenu">
      <div class="menu-item-container">
        <el-menu-item index="/">
          <img src="/image/main/topMenu/logo.png" class="menu-icon">
        </el-menu-item>
      </div>
...
.el-menu-demo {
  ...
  height: 80px;
  background: #FFFFFF;
  box-shadow: 0 2px 16px 0 rgba(20, 24, 63, 0.08);
  display: flex;
