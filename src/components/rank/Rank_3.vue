<template>
    <div class="ranking-container">
      ...
      <h1 class="main-title">大模型伦理评测排行榜</h1>
      ...
      <div class="ranking-list">
        <div class="list-header">
          ...
          <div class="header-version">参数量</div>
          ...
          <div v-for="(model, index) in filteredModels" 
            ...
            <div class="model-column">
              ...
              <div class="model-meta">
                <span class="tag-closed" v-if="model.modelsize=='*'">闭源</span>
                <span class="tag-closed" v-if="model.modelsize!='*'">开源</span>
  ...
  import modelStore from './modelStore2';
